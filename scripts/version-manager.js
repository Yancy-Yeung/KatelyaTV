...
#### Docker 部署
\`\`\`bash
docker pull ghcr.io/yancy-yeung/katelyatv:v${newVersion}
docker run -d --name katelyatv -p 3000:3000 --env PASSWORD=your_password ghcr.io/yancy-yeung/katelyatv:v${newVersion}
\`\`\`
...
### 🔗 相关链接
- [项目主页](https://github.com/Yancy-Yeung/KatelyaTV)
- [在线演示](https://katelyatv.vercel.app)
- [问题反馈](https://github.com/Yancy-Yeung/KatelyaTV/issues)
- [功能建议](https://github.com/Yancy-Yeung/KatelyaTV/discussions)
